...
class OperationsControllerTest < ActionController::TestCase
  ...
  test "should create operation" do
    assert_difference('Operation.count') do
      post :create, operation: { date_op: @operation.date_op, sum: @operation.sum, text: @operation.text, type_op: @operation.type_op }
    end
  ...
  test "should update operation" do
    patch :update, id: @operation, operation: { date_op: @operation.date_op, sum: @operation.sum, text: @operation.text, type_op: @operation.type_op }
    assert_redirected_to operation_path(assigns(:operation))
  end
